...
@section('content')
    @if (Auth::user()->role->id == '346d417a-544d-48f3-bb4d-1da4ce54dffc' ||
            Auth::user()->role->id == '2629192e-1c3f-477e-a157-4def565dace3')
        <div class="row align-items-center">
            <div class="col-md-2">
                <div class="mb-3">
                    <a href="{{ route('transactions.create') }}" class="btn btn-primary"><i class="bx bx-plus me-1"></i>
                        Tambah</a>
                </div>
            </div>
        </div>
